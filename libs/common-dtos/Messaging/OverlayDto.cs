...
public class OverlayDto
{
    ...
    [JsonPropertyName("resolution_m_per_px")] public double ResolutionMPerPx { get; set; }
    [JsonPropertyName("algorithm_name")] public AlgorithmName AlgorithmName { get; set; }
    [JsonPropertyName("image_width")] public int ImageWidth { get; set; }
    [JsonPropertyName("image_height")] public int ImageHeight { get; set; }
    [JsonPropertyName("roifootprint")] public JsonElement RoiFootprint { get; set; }
    [JsonPropertyName("image_time")] public DateTimeOffset? ImageTime { get; set; }
